...
#define EVENT_TYPE_LIGHT_HW         REL_HWHEEL
#define EVENT_TYPE_LIGHT_D          REL_DIAL
#define EVENT_TYPE_LIGHT_W          REL_WHEEL
#define EVENT_TYPE_LIGHT_M          REL_MISC

#define EVENT_TYPE_GYRO_X           REL_RX
#define EVENT_TYPE_GYRO_Y           REL_RY
#define EVENT_TYPE_GYRO_Z           REL_RZ

#define EVENT_TYPE_PRESSURE_H       REL_HWHEEL
#define EVENT_TYPE_PRESSURE_D       REL_DIAL
#define EVENT_TYPE_PRESSURE_W       REL_WHEEL
